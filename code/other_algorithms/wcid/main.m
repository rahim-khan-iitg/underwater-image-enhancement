...
for file=files
    ...
    imwrite(firstInput,strcat("D:\MSc Books\Sem 4\Project\underwater_image_enhancement\images\white_balance\",file))
    ...
    imwrite(enhancedImage,strcat("D:\MSc Books\Sem 4\Project\underwater_image_enhancement\images\wcid\",file))
end